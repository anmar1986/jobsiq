...
const localLinks = ref<SocialLinks>({ ...props.socialLinks })

watch(() => props.socialLinks, (newLinks) => {
  localLinks.value = { ...newLinks }
}, { deep: true })

const updateField = (field: keyof SocialLinks, value: string | number) => {
  localLinks.value[field] = value as string
  emit('update:social-links', { ...localLinks.value })
}
</script>
