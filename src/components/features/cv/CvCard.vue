<template>
  <BaseCard
    ...
    @click="$emit('click', cv)"
  >
    <!-- Badges (Primary & Public/Private) -->
    <div class="absolute top-4 right-4 z-10 flex gap-2">
      <!-- Primary Badge -->
      <BaseBadge v-if="cv.is_primary" variant="primary" size="sm">
      ...
      <BaseBadge v-if="cv.is_public" variant="success" size="sm">
      ...
      <BaseBadge v-else variant="secondary" size="sm">
        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
