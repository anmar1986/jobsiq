    ...
    <div class="space-y-4">
      <div class="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-600 mt-1">
            Allow employers and recruiters to view your CV in the public CV directory.
          </p>
        </div>
      </div>
      ...
      <div class="flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div class="flex-1">
          ...
          <p class="text-xs text-gray-600 mt-1">
            This CV will be used as your default when applying for jobs. Only one CV can be primary.
          </p>
        </div>
      </div>
    </div>
