      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-2">
            ...
            <span class="text-2xl font-bold text-white">JobsIQ</span>
          </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><router-link to="/about" class="text-sm hover:text-primary-500 transition-colors">About Us</router-link></li>
            <li><a href="#" class="text-sm hover:text-primary-500 transition-colors">Contact</a></li>
            <li><a href="#" class="text-sm hover:text-primary-500 transition-colors">Privacy Policy</a></li>
            <li><a href="#" class="text-sm hover:text-primary-500 transition-colors">Terms of Service</a></li>
          </ul>
        </div>
      </div>
