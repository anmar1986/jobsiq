              ...
              <div class="mb-6 pb-6 border-b border-gray-200">
                ...
                <div class="space-y-2">
                  ...
                  <BaseButton
                    variant="outline"
                    size="sm"
                    class="w-full justify-start text-red-600 hover:text-red-700 hover:border-red-600 hover:bg-red-50"
...
const handleDeleteCompany = async () => {
  ...
  try {
    const response = await companyService.deleteCompany(company.value.id)
    if (response.success) {
