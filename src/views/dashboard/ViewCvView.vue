    ...
    <div v-else-if="cv" class="max-w-4xl mx-auto">
      ...
      <BaseCard noPadding class="p-4 mb-4">
        <div class="flex items-start justify-between mb-6">
          <div class="flex items-start gap-6 flex-1">
            <!-- Profile Image -->
            <div class="w-24 h-24 bg-gray-100 rounded-full overflow-hidden flex-shrink-0 flex items-center justify-center ring-4 ring-gray-200">
              <img
            ...
            <div class="flex-1">
              ...
              <p class="text-xl text-primary-600 font-medium mb-4">{{ cv.title || 'No title specified' }}</p>
              
              <!-- Badges -->
              <div class="flex flex-wrap gap-2 mb-4">
                <BaseBadge v-if="cv.is_primary" variant="primary">
                  <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  Primary CV
                </BaseBadge>
                <BaseBadge :variant="cv.is_public ? 'success' : 'secondary'">
          ...
          <div class="flex gap-2 flex-shrink-0">
            ...
            <button
              ...
              class="px-4 py-2 text-red-600 border border-red-300 rounded-lg hover:bg-red-50 transition-colors text-sm font-medium"
            >
      ...
      <BaseCard v-if="educationEntries.length > 0" noPadding class="p-4 mb-4">
        ...
        <div class="space-y-6">
          <div
            ...
            class="pb-6 border-b border-gray-200 last:border-0 last:pb-0"
          >
            <h3 class="text-lg font-bold text-gray-900">{{ edu.degree }} in {{ edu.field }}</h3>
      ...
      <BaseCard v-if="certifications.length > 0" noPadding class="p-4 mb-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
          ...
          >
            <h3 class="font-bold text-gray-900 mb-1">{{ cert.name }}</h3>
